...
ifeq ($(config),debug)
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../../../opt/homebrew/Cellar/freetype/2.14.3/lib" -L"../../../../../opt/homebrew/Cellar/libpng/1.6.58/lib" -L"../olcTemplate/sdk/box2d/macos" -L"../olcTemplate/sdk/lua-5.4.2/macos" -L"../olcTemplate/sdk/soloud/macos" -L"."
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
...
ifeq ($(config),debug64)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../../../opt/homebrew/Cellar/freetype/2.14.3/lib" -L"../../../../../opt/homebrew/Cellar/libpng/1.6.58/lib" -L"../olcTemplate/sdk/box2d/macos" -L"../olcTemplate/sdk/lua-5.4.2/macos" -L"../olcTemplate/sdk/soloud/macos" -L"." -m64
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
  LIBS               += $(LDDEPS) -lbox2d -lfreetype -lpng -llua -lsoloud_static -framework OpenGL -framework GLUT -framework Carbon -framework AudioToolbox
...
ifeq ($(config),debuguniv64)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../../../opt/homebrew/Cellar/freetype/2.14.3/lib" -L"../../../../../opt/homebrew/Cellar/libpng/1.6.58/lib" -L"../olcTemplate/sdk/box2d/macos" -L"../olcTemplate/sdk/lua-5.4.2/macos" -L"../olcTemplate/sdk/soloud/macos" -L"." -arch x86_64 -arch ppc64
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
  LIBS               += $(LDDEPS) -lbox2d -lfreetype -lpng -llua -lsoloud_static -framework OpenGL -framework GLUT -framework Carbon -framework AudioToolbox
